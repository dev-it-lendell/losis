<?php
	...
	while ($row = mysqli_fetch_array($query)) {
		...
		$cTeam = $row['Cteam'];
		$team_ = $row['team_'];
		$clnt_fname = $row['fname'];
		$clnt_mname = $row['mname'];
		$clnt_lname = $row['lname'];
		$clnt_suffix = $row['suffix'];
