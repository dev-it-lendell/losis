                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $sql = "SELECT 
                                                                    ...
                                                                    b.email_addr, 
                                                                    b.mobile_no,
                                                                    c.site_ AS client_site,
                                                                    c.client_name AS client_name
                                                                FROM 
                                                                    application_list AS a
                                                                LEFT JOIN 
                                                                    application_personal_info AS b 
                                                                    ON a.application_code = b.application_code
                                                                LEFT JOIN 
                                                                    client_list AS c 
                                                                    ON a.client_id = c.client_id
                                                                WHERE 
                                                                    a.client_name = '$clnt_company'
                                                                ORDER BY 
                                                                    a.application_status";
                                                                ...
                                                                while ($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $row['client_name'].' '.$row['client_site']; ?></td>
                    ...
                    <div class="endorsement-item mb-3">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="hidden" name="acronym" value="<?php echo $clnt_acronym; ?>">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control batchId" name="batchId" placeholder="Batch ID (Optional)" >
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control biId" name="biId" placeholder="BI ID (Optional)" >
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class="form-control package" name="package" id="app_package" required onchange="packageValidation();">
                                    <option value="">-- Select Package --</option>
                                    <option value="Package A">LDL-SM Rank & File (Fresh Graduate)</option>
                                    <option value="Package B">LDL-SM Rank & File (With Experience)</option>
                                    <option value="Package C">LDL-SM Supervisor 1/ Officer</option>
                                    <option value="Package D">LDL-SM Manager/ Sr. Manager/ Executive</option>
                                </select>
                            </div>
                            <small class="text-muted">Select a package from the dropdown</small>
                            <div id="package_feedback" class="invalid-feedback">Please select a valid package</div>
                        </div>
                        <!--<div class="form-group">-->
                        <!--    <label for="package">Package</label>-->
...
<script>
    ...
    if (form.checkValidity()) {
        ...
        fetch('/LOSIS/clientUser_/functions/save_appl_endorsement.php', {
            method: 'POST',
            body: formData
        })
