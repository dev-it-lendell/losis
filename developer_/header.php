...
<body data-theme="light" class="font-nunito">
    <div id="wrapper" class="theme-green">
        ...
        <div class="right_icon_bar">
            <ul>
                <li onclick="savedevuserprofile();"><a href="user_profile.php" data-toggle="tooltip" data-placement="top" title="My Profile"><i class="fa fa-user"></i></a></li>
                <li onclick="savedevusermessaging();"><a href="user_messaging.php" data-toggle="tooltip" data-placement="top" title="Messaging"><i class="fa fa-comments"></i></a></li>
                <li style="display: none;"><a href="#" data-toggle="tooltip" data-placement="top" title="Update Account"><i class="fa fa-key"></i></a></li>
            </ul>
        </div>
    </div>
