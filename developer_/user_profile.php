                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex flex-row-reverse">
                            <div class="page_action" onclick="savedevviewupdateprofile();">
                                <a class="btn btn-success" href="update_user_profile.php?userID=<?php echo $devid ?>" style="float: right; margin-left: 5px;"><i class="fa fa-pencil-square-o"></i> Edit My Profile</a>
                            </div>
                        </div>
                    </div>                
                </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card profile-header">
                        <div class="body text-center">
                            <?php
                                echo '<div class="profile-image mb-3 text-center"> <img class="img-fluid rounded" src="../profilepictures_/'.$devid.'/'.$dev_userimage.'" alt=""> </div>'
                            ?>
                            <div class="mt-4">
                                <h4 class="mb-0"><strong><?php echo $dev_name; ?></strong></h4>
                                <span class="job_post"><?php echo $dev_position; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-unstyled">
                                <li><p><i class="fa fa-calendar mr-2"></i><strong>Date of Birth:</strong>&nbsp;&nbsp;<?php echo $dev_newdateofbirth; ?></p></li>
                                <li><p><i class="fa fa-user mr-2"></i><strong>Age:</strong>&nbsp;&nbsp;<?php echo $dev_userage; ?></p></li>
                                <li><p><i class="fa fa-phone-square mr-2"></i><strong>Contact Number:</strong>&nbsp;&nbsp;<?php echo $dev_contact; ?></p></li>
                                <li><p><i class="fa fa-map-marker mr-2"></i><strong>Address:</strong>&nbsp;&nbsp;<?php echo $dev_fulladdress; ?></p></li>
                            </ul>
                            <hr> 
                           ...
                           <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="my_user_logs.php" onclick="savedevviewuserlogs();" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="View User Logs"><i class="fa fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                           ...
                           <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="my_activity_logs.php" onclick="savedevviewactivitylogs();" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="View Activity Logs"><i class="fa fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="body">
                            <table class="table mb-0">
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM tbl_developer_history_logs WHERE MONTH(datetime_log) = MONTH(NOW()) AND YEAR(datetime_log) = YEAR(NOW()) AND user_id = '".$_SESSION["user_id"]."' ORDER BY id DESC LIMIT 5";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
