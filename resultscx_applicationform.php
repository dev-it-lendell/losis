			...
			<div class="container-fluid">
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12">
						<div class="card planned_task" style="background-color: #F2F2F2;">
							<div class="header">
								<img src="images/resultscx/logo.svg" style="max-width: 100%;
	 								height:80px; float: left; margin-bottom: 20px;" alt="ResultsCX Logo"></img>
	 							<img src="images/lendell/logo-1.png" style="max-width: 100%;
	 								height:80px; float: right; padding-top: 20px; margin-bottom: 20px;" alt="Lendell Logo"></img>
								<div class="card" style="height: 85px; background-color: #F2F2F2;">
									<div class="card-body">
							...
							<div class="body" style="margin-top: 20px;">
								...
								<form action="functions/save_application.php" method="POST" enctype="multipart/form-data">
									<div class="tab-content">
															...
															<div class="row">
																<div class="col-md-3">
			                                                        <div class="input-group mb-3">
			                                                            ...
			                                                            <input type="hidden" class="form-control" id="client_id" name="client_id" value="LOSIS-000052" autocomplete="off">
		                                ...
		                                <button type="submit" class="btn btn-outline-primary" name="newapplication" id="btncheck" disabled><i class="fa fa-check-circle-o"></i> Save</button>
