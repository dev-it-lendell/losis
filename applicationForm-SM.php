																...
																<div class="col-md-3">
			                                                        <div class="input-group mb-3">
			                                                            ...
			                                                            <select class="form-control form-control" id="user_id" name="user_id" required>
                                                                            <?php
                                                                                $sql = "SELECT `client_id`, `site_` FROM `client_list` WHERE `acronym_` = 'SMR' ORDER BY site_ ASC";
                                                                                ?> <option value = ""> -- Select Site -- </option>; <?php
                                                                                $res = $conn->query($sql);
                                                                                while ($row = mysqli_fetch_array($res)) { ?>
                                                                                        <option value ="<?php echo $row['client_id'];?>">SM Store <?php echo $row['site_'];?> </option>
                                                                                    <?php
                                                                                }
                                                                            ?>
                                                                        </select>
															...
															<div class="row">
																<div class="col-md-3">
			                                                        <div class="input-group mb-3">
			                                                            ...
			                                                            <input type="hidden" class="form-control" id="client_name" name="client_name" value="SM Store">
			                                                            <input type="hidden" class="form-control" id="client_acronym" name="client_acronym" value="SMR">
			                                                        </div>
																</div>
																<div class="col-md-3">
			                                                        <div class="input-group mb-3">
												...
												<div class="col-lg-12">
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="row">
																<div class="col-md-12">
																	<p style="font-size: 15px; font-weight: bold; text-align: center;">Senior High School</p>
																	<hr>
																	<div class="row">
																		<div class="col-md-12">
					                                                        <div class="input-group mb-3">
					                                                            ...
					                                                            <input type="text" class="form-control" id="appr_shs_school" name="appr_shs_school" autocomplete="off" placeholder="School/University">
					                                                        </div>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-md-12">
					                                                        <div class="input-group mb-3">
					                                                            ...
					                                                            <input type="text" class="form-control" id="appr_shs_track" name="appr_shs_track" autocomplete="off" placeholder="Strand/Track">
					                                                        </div>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-md-12">
																			<div class="input-group mb-3">
																				...
																				<input data-provide="datepicker" data-date-autoclose="true" class="form-control" data-date-format="yyyy-mm-dd" id="appr_shs_dategrad" name="appr_shs_dategrad" placeholder="Date Graduated"> 
																			</div>
																		</div>
																	</div>
																	<div class="row">
																		<div class="col-md-12">
	                                                        				<textarea class="form-control" rows="5" id="appr_shs_addr" name="appr_shs_addr" style="resize: none;" autocomplete="off" maxlength="200" placeholder="School Address"></textarea>
                                                    						<div id="collegeaddr_feedback"></div>
																		</div>
																	</div>
																</div>
