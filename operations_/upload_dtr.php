                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex flex-row-reverse">
                            <div class="page_action" onclick="saveopsdownloaddtr();">
                                <a class="btn btn-success" href="download_dtr.php?file=dtr_template/operations_dtr_template_2023.csv" style="float: right;"><i class="fa fa-download"></i> Download DTR</a>
                            </div>
                        </div>
                    </div>                
                </div>
									...
									<div class="media mleft">
										...
										<div class="media-body">
											<h4 class="media-heading">Uploading of your DTR</h4>
												Team <?php echo $ops_teamname; ?>
										</div>
									</div>
								</div>
							</div>
						</div>
						<form class="form" method="POST" enctype="multipart/form-data" action="functions/save_dtr.php">
							<div class="header">
								<div class="row">
									<div class="col-md-12">
										<div class="row">
											<div class="col-md-6">
												<small class="text-muted">Full Name: </small>
													<p style="font-weight: bold;"><?php echo $ops_name; ?></p>
												<hr>
											</div>
											<div class="col-md-6">
												<small class="text-muted">Designation: </small>
													<p style="font-weight: bold;"><?php echo $ops_position; ?></p>
												<hr>
											</div>
										</div>
									</div>
