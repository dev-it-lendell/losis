								...
								<div class="body">
									<div class="row text-center border-bottom pb-2">
										<div class="col-md-12">
											...
											<p style="font-size: 13px; font-weight: bold;" id="endorsement_applname"></p><br>
...
<div class="modal" id="mdlreturnendorsement" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
		<div class="modal-content"> 
									...
									<div class="row">
										<div class="col-md-12">
											<div class="row">
												...
												<div class="col-md-6" id="returnsupervisor" style="display: none;">
													<p style="font-size: 13px;">Assigned <strong>Supervisor</strong></p>
													<p style="font-size: 13px; font-weight: bold; text-align: left; margin-top: -18px;" id="supervisorname"></p>
												</div>
												<div class="col-md-6" id="returnverifier" style="display: none;">
													<p style="font-size: 13px;">Assigned <strong>Verifer</strong></p>
													<p style="font-size: 13px; font-weight: bold; text-align: left; margin-top: -18px;" id="verifiername"></p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="body" style="margin-top: -40px;">
									<div class="row">
										<div class="col-md-12">
											...
											<input type="text" id="verifiercode" style="display: none;">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-info" id="btnreturnedbitele" style="display: none;" onclick="returnedendobitele();"><i class="fa fa-undo"></i> RETURN</button>
				<button type="button" class="btn btn-info" id="btnreturnedbida" style="display: none;" onclick="returnedendobida();"><i class="fa fa-undo"></i> RETURN</button>
				<button type="button" class="btn btn-info" id="btnreturneddcda" style="display: none;" onclick="returnedendodcda();"><i class="fa fa-undo"></i> RETURN</button>
								...
								<div class="body">
									<div class="row">
										<div class="col-md-12">
											...
											<hr>
											<small class="text-muted" style="display: none;" id="poctitle">Assigned Supervisor: </small>
												<p id="returnendo_poc"></p>
											<hr style="display: none;" id="pochr">
											...
											<hr style="display: none;" id="telehr">
								...
								<div class="body">
									<div class="row">
										<div class="col-md-12">
											...
											<hr>
											<small class="text-muted" style="display: none;" id="pochisttitle">Assigned Supervisor: </small>
												<p id="returnhistendo_poc"></p>
											<hr style="display: none;" id="pochisthr">
											...
											<hr style="display: none;" id="telehisthr">
											...
											<hr style="display: none;" id="dahisthr">
											<small class="text-muted">Date and Time Returned: </small>
												...
												<div class="col-md-12">
													...
													<div class="table-responsive">
														<table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
															...
															<tbody>
																<?php
																	$sql = "SELECT a.ticket_id, a.reference_number, a.requestor, a.ticket_status, a.date_created, a.start_date, a.end_date, b.user_id, CONCAT(b.fname, ' ', b.mname, ' ', b.lname, ' ', b.suffix) AS fullname, b.user_image FROM tbl_tickets AS a LEFT JOIN tbl_operations AS b ON a.requestor = b.user_id WHERE MONTH(a.date_created) = MONTH(NOW()) AND YEAR(a.date_created) = YEAR(NOW()) AND a.requestor = '".$_SESSION["user_id"]."'";
