<?php
    ...
    if (isset($_POST['createReport'])) {
	    ...
	    while ($row = mysqli_fetch_array($query)) {
        	...
        	$month = date('F');
        	$day = date('d');
			$target_dir = "../../supervisor_/da_to_poc_files/{$year}/{$endoCode}";
	        ...
	        $conn->query("INSERT INTO bi_report_assessment SET report_code = '$ReportCode', endo_code = '$reference_code', residence_addr = '$residence_addr', business_addr = '$business_addr', contact_details = '$contact_details', initiation_date = '$intiation_date', initial_date_submitted = '$subminitial_date', final_date_submitted = '$submfinal_date', personal_bg_remarks = '$personalbg_remarks', personal_bg_color = '$personalbg_color', academic_chk_remarks = '$academichk_remarks', academic_chk_color = '$academichk_color', employment_hist_remarks = '$emphist_remarks', employment_hist_color = '$emphist_color', character_ref_remarks = '$charref_remarks', character_ref_color = '$charref_color', identity_sss_remarks = '$identitysss_remarks', identity_sss_color = '$sss_color', identity_bir_remarks = '$identitybir_remarks', identity_bir_color = '$bir_color', criminal_nbi_remarks = '$criminalnbi_remarks', criminal_nbi_color = '$nbi_color', criminal_lcc_remarks = '$criminallcc_remarks', criminal_lcc_color = '$lcc_color', credit_cmap_remarks = '$creditcmap_remarks', credit_cmap_colors = '$credit_color', int_gdc_remarks = '$intgdc_remarks', int_gdc_color = '$intgdc_color', brgy_chk_remarks = '$barangay_remarks', brgy_chk_color = '$barangay_color', neighborhood_ref_remarks = '$neighbhood_remarks', neighborhood_ref_color = '$neighbhood_color', pol_religious_remarks = '$polreligous_remarks', pol_religious_color = '$polreligous_color', lifestyle_remarks = '$lifestyle_remarks', lifestyle_color = '$lifestyle_color', financial_rev_remarks = '$financialrev_remarks', financial_rev_color = '$financialrev_color', recommendation_ = '$recommendation_'");
	        if ($personal_bg == '1') {
				$conn->query("INSERT INTO report_personalbg SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$pb_color', remarks_ = '$pb_remarks'");
				
	        } else {
	        	echo "";
	        }
	        if ($academic_ == '1') {
				$conn->query("INSERT INTO report_academic SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$academic_color', school_ = '$academic_school', reported_degree = '$academic_reported_degree', verified_degree = '$academic_verified_degree', reported_yeargrad = '$academic_reported_gradyear', verified_yeargrad = '$academic_verified_gradyear', date_attended_to  = '$academic_enddate', date_attended_from  = '$academic_startdate', highest_educ_attainment  = '$academic_attainment', remarks_ = '$academic_remarks', informant_ = '$academic_informant'");
	        } else {
	        	echo "";
	        }
	        if ($emp_history == '1') {
	        	$conn->query("INSERT INTO report_emphistory SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$emp_color', company_ = '$emp_company', reported_period_emp_from = '$emp_reported_todate', reported_period_emp_to = '$emp_reported_fromdate', verified_period_emp_from = '$emp_verified_todate', verified_period_emp_to = '$emp_verified_fromdate', reported_position = '$emp_reported_position', verified_position = '$emp_verified_position', reported_employment_ended = '$emp_reported_empended', verified_employment_ended = '$emp_verified_empended', nature_business = '$emp_businessnature', any_records = '$emp_derogatory', eligible_for_rehire = '$emp_rehire', remarks_ = '$emp_remarks', informant_ = '$emp_informant'");
	        } else {
	        	echo "";
	        }

	        if ($char_references == '1') {
	        	$conn->query("INSERT INTO report_character_ref SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$charone_color', fname_  = '$charone_fname', mname_ = '$charone_mname', lname_ = '$charone_lname', suffix_ = '$charone_suffix', employer_and_position = '$charone_empposition', contact_details = '$charone_contact', remarks_ = '$charone_remarks'");
	        } else {
	        	echo "";
	        }
	        if ($identity_sss == '1') {
	        	$conn->query("INSERT INTO report_identity_sss SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$identitysss_color', findings_  = '$identitysss_findings'");
	        } else {
	        	echo "";
	        }
	        if ($identity_bir == '1') {
	        	$conn->query("INSERT INTO report_identity_bir SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$identitybir_color', findings_  = '$identitybir_findings'");
	        } else {
	        	echo "";
	        }
	        if ($criminal_nbi == '1') {
	        	$conn->query("INSERT INTO report_criminal_nbi SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$criminalnbi_color', findings_  = '$criminalnbi_findings'");
	        } else {
	        	echo "";
	        }
	        if ($criminal_lcc == '1') {
	        	$conn->query("INSERT INTO report_criminal_lcc SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$criminallcc_color', findings_  = '$criminallcc_findings'");
	        } else {
	        	echo "";
	        }
	        if ($credit_cmap == '1') {
	        	$conn->query("INSERT INTO report_credit_cmap SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$creditcmap_color', court_cases  = '$creditcmap_courtcases', returned_checks  = '$creditcmap_returnedchks', account_lawyers  = '$creditcmap_accountlawyers', telecoms_bank  = '$creditcmap_telecoms'");
	        } else {
	        	echo "";
	        }
	        if ($international_chk == '1') {
	        	$conn->query("INSERT INTO report_international_check SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$intchk_color', findings_  = '$intchk_findings'");
	        } else {
	        	echo "";
	        }
	        if ($barangay_chk == '1') {
	        	$conn->query("INSERT INTO report_barangay_check SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$brgy_color', brgy_name  = '$brgy_name', brgy_informant  = '$brgy_informant', position_  = '$brgy_position', contact_  = '$brgy_contact'");
	        } else {
	        	echo "";
	        }
	        if ($neighborhood_ref == '1') {
	        	$conn->query("INSERT INTO report_neighbhood_ref SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$nbhoodone_color', fname_  = '$nbhoodone_fname', mname_ = '$nbhoodone_mname', lname_ = '$nbhoodone_lname', suffix_ = '$nbhoodone_suffix', current_address = '$nbhoodone_addr', contact_info = '$nbhoodone_contact', remarks_ = '$nbhoodone_remarks'");
	        } else {
	        	echo "";
	        }
	        if ($political_religious_aff == '1') {
	        	$conn->query("INSERT INTO report_political_religious SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$polreg_color', remarks_  = '$polreg_remarks'");
	        } else {
	        	echo "";
	        }
	        if ($lifestyle_chk == '1') {
	        	$conn->query("INSERT INTO report_lifestyle_check SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$lifestylechk_color', remarks_  = '$lifestylechk_remarks'");
	        } else {
	        	echo "";
	        }
	        if ($financial_review == '1') {
	        	$conn->query("INSERT INTO report_financial_review SET report_code = '$ReportCode', endo_code = '$reference_code', status_code = '$financialchk_color', remarks_  = '$financialchk_remarks'");
	        } else {
	        	echo "";
	        }
			...
			$sql = "INSERT INTO tbl_operations_history_logs SET
						...
						x_module_action = 'Saving of Report'";
			$res = $conn->query($sql);                           
			if ($res) {
			...
			$sql1 = "INSERT INTO tbl_operations_history_logs SET
	                    ...
	                    x_module_action = 'View Monitor Endorsements (BI - Verifier)'";
			...
			$qstring = '?bisavereport=succsend';
	    }
    } else {
    	$qstring = '?bisavereport=errsend';
    }
