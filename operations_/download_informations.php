<?php
    ...
    while($EmploymentRow = mysqli_fetch_array($Employmentresult)) {
        ...
        $pdf->SetFont('Century Gothic','',8);
        $pdf->Cell(50	,5,$EmploymentRow['employer_'],'LBT,RB',0);
        $pdf->Cell(30	,5,$EmploymentRow['contact_no'],'LBT,RB',0);
        $pdf->Cell(60	,5,$EmploymentRow['job_title'],'LBT,RB',0);
        $pdf->Cell(25	,5,$EmploymentRow['start_date'],'LBT,RB',0);
        $pdf->Cell(25	,5,$EmploymentRow['end_date'],'LBT,RB',1);
        $pdf->SetFont('Century Gothic','B',8);
        $pdf->Cell(50	,5,'Employer Address',1,0,'C');
        $pdf->SetFont('Century Gothic','',8);
        $pdf->MultiCell(140, 5, $EmploymentRow['emp_addr'], 'LBT,RB',false);
        $pdf->Cell(190 ,3,'',0,1);
