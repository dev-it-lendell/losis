				...
				<div class="row">
					<div class="col-lg-8 col-md-6 col-sm-12">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active">Send To Supervisor</li>
						</ul>	
					</div>
				</div>
			</div>
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12">
					<div class="card planned_task">
						...
						<form class="form" method="POST" enctype="multipart/form-data" action="functions/save_supervisor_report.php">
							<div class="body">
								<div id="wrapper" class="theme-green">
									<div class="row clearfix">
												...
												<div class="body">
													...
													<div class="row text-center mt-2 border-bottom pb-2">
														...
														<div class="col-md-6">
															...
															<p style="font-size: 13px; font-weight: bold;" id="biendorsement_code"><?php echo $folder_name; ?></p>
														</div>
														<p id="biendorsement_id" style="font-size: 13px; display: none;"><?php echo $endo_id; ?></p>
														<input type="hidden" class="form-control" name="endocode" readonly style="background-color: #fff; text-align: left; color: #000; font-size: 13px;" value="<?php echo $endoCode; ?>">
														<input type="hidden" class="form-control" name="endoid" readonly style="background-color: #fff; text-align: left; color: #000; font-size: 13px;" value="<?php echo $endo_id; ?>">
														<input type="hidden" class="form-control" name="clientid" readonly style="background-color: #fff; text-align: left; color: #000; font-size: 13px;" value="<?php echo $clientid; ?>">
															...
															<div class="row">
																<div class="col-md-6">
																	<small class="text-muted">Turn Around Date: </small>
																		<p id="biendorsement_tadate"><?php echo $newTurnAroundDate; ?></p>
																	<hr>
																</div>
																<div class="col-md-6">
									...
									<div class="row clearfix">
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="card">
												<div class="header">
													<h2><strong>Upload</strong> Final Report</h2>
												</div>
												<div class="body">
	                                                <div class="row">
	                                                    <div class="col-md-12">
					                                ...
					                                <button type="submit" class="btn btn-outline-success mt-3" name="sendreporttoclient"><i class="fa fa-check-circle-o"></i> Submit</button>
