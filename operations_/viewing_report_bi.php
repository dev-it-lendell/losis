                                    ...
                                    <div class="card-body">
                                        <div class="media mleft">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading">Viewing of report</h4>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="body">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $residence_addr; ?>">
                                                            </div>
                                                            <div class="input-group input-group-sm">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $business_addr; ?>">
                                                            </div>
                                                            <div class="input-group input-group-sm">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $contact_details; ?>">
                                                            </div>
                                                            <div class="input-group input-group-sm">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $endoCode; ?>">
                                                            </div>
                                                            <div class="input-group input-group-sm">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $Newinitiationdate; ?>">                   
                                                            </div>
                                                            <div class="input-group input-group-sm">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $Newinitialdatesubm; ?>">
                                                            </div>
                                                            <div class="input-group input-group-sm">
                                                                <div class="input-group-prepend">
                                                                ...
                                                                <input type="text" class="form-control" readonly style="background-color: #fff;" value="<?php echo $Newfinaldatesubm; ?>">
                                                            </div>
                                                                        ...
                                                                        if ($personal_bg == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $personal_bg_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                                            if ($row1['personal_bg_color'] == '0'){
                                                                                                ?>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="CLEARED">
                                                                                                <?php
                                                                                            }
                                                                                            elseif ($row1['personal_bg_color'] == '1'){
                                                                                                ?>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="FOR REVIEW">
                                                                                                <?php
                                                                                            }
                                                                                            elseif ($row1['personal_bg_color'] == '2'){
                                                                                                ?>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="FAILED">
                                                                                                <?php
                                                                                            }
                                                                                        ?>
                                                                                    </td>
                                                                        ...
                                                                        if ($academic_ == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $academic_chk_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($emp_history == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $employment_hist_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($char_references == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $character_ref_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($identity_sss == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $identity_sss_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($identity_bir == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $identity_bir_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($criminal_nbi == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $criminal_nbi_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($criminal_lcc == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $criminal_lcc_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($credit_cmap == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $credit_cmap_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($international_chk == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $int_gdc_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($barangay_chk == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $brgy_chk_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($neighborhood_ref == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $neighborhood_ref_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($political_religious_aff == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $pol_religious_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($lifestyle_chk == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $lifestyle_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                        ...
                                                                        if ($financial_review == '1') {
                                                                            ?>
                                                                                <tr style="height: 2px;">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold; text-align: center;" readonly value="<?php echo $financial_rev_remarks; ?>">
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <?php
                                                                    if ($row1['recommendation_'] == '0'){
                                                                        ?>
                                                                        <input type="text" class="form-control" style="background-color: #fff; font-weight: bold; text-align: center;" readonly value="CLEARED">
                                                                        <?php
                                                                    }
                                                                    elseif ($row1['recommendation_'] == '1'){
                                                                        ?>
                                                                        <input type="text" class="form-control" style="background-color: #fff; font-weight: bold; text-align: center;" readonly value="FOR REVIEW">
                                                                        <?php
                                                                    }
                                                                    elseif ($row1['recommendation_'] == '2'){
                                                                        ?>
                                                                        <input type="text" class="form-control" style="background-color: #fff; font-weight: bold; text-align: center;" readonly value="FAILED">
                                                                        <?php
                                                                    }
                                                                ?>
                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-sm-12" style="margin-top: -40px;">
                                                                                ...
                                                                                <?php
                                                                                    if ($row2['status_code'] == '0'){
                                                                                        ?>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold;" readonly value="CLEARED">
                                                                                        <?php
                                                                                    }
                                                                                    elseif ($row2['status_code'] == '1'){
                                                                                        ?>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold;" readonly value="FOR REVIEW">
                                                                                        <?php
                                                                                    }
                                                                                    elseif ($row2['status_code'] == '2'){
                                                                                        ?>
                                                                                        <input type="text" class="form-control" style="background-color: #fff; border: none; font-weight: bold;" readonly value="FAILED">
                                                                                        <?php
                                                                                    }
                                                                                ?>
                                                                            </div>
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarkspersonalbg_; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $school_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <br>
                                                                                ...
                                                                                <table class="table m-b-0 2c_list">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr style="height: 2px;">
                                                                                            ...
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $reported_degree; ?>">
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $verified_degree; ?>">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="height: 2px;">
                                                                                            <td style="font-size: 13px; font-weight: bold; width: 10%;">Year Graduated</td>
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $reported_yeargrad; ?>">
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $verified_yeargrad; ?>">
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-6 col-sm-12">
                                                                                ...
                                                                                <div class="input-daterange input-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $Newdateattendedfrom; ?>">
                                                                                    <span class="input-group-text">to</span>
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $Newdateattendedto; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Highest Educational Attainment:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $highest_educ_attainment; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarksacademic_; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $informantacademic_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $company_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <br>
                                                                                ...
                                                                                <table class="table m-b-0 2c_list">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr style="height: 2px;">
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="input-daterange input-group">
                                                                                                    <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $Newreportedempfrom; ?>">
                                                                                                    <span class="input-group-text" style="border: none;">to</span>
                                                                                                    <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $Newreportedempto; ?>">
                                                                                                </div>
                                                                                            </td>
                                                                                            <td>
                                                                                                <div class="input-daterange input-group">
                                                                                                    <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $Newverifiedempfrom; ?>">
                                                                                                    <span class="input-group-text" style="border: none;">to</span>
                                                                                                    <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $Newverifiedempto; ?>">
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="height: 2px;">
                                                                                            ...
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $reported_position; ?>">
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $verified_position; ?>">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="height: 2px;">
                                                                                            <td style="font-size: 13px; font-weight: bold; width: 10%;">Reason employment ended</td>
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $reported_employment_ended; ?>">
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" class="form-control" style="background-color: #fff; border: none;" readonly value="<?php echo $verified_employment_ended; ?>">
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $nature_business; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $any_records; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $eligible_for_rehire; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarksemployment_; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Informant:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $informantemployment_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-3 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $fnamecharref_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Middle Name:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $mnamecharref_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Last Name:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $lnamecharref_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Suffix:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $suffixcharref_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-6 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $employer_and_position; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Contact Details:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $contact_detailscharref; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarkscharref_; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $findings_sss; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Findings:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $findings_bir; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Findings:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $findings_nbi; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Findings:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $findings_lcc; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $court_cases; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $returned_checks; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $account_lawyers; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $telecoms_bank; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Findings:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $findings_intcheck; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                                <div class="card">
                                                                    ...
                                                                    <div class="header" style="margin-top: -30px;">
                                                                        <p style="font-size: 13px;"><strong>Verification made with Brgy. <input type="text" class="form-control" style="background-color: #fff; border: none;" value="<?php echo $brgy_name; ?>"> showed that our subject is negative of any pending barangay cases neither had any information of any derogatory record as of date of inquiry.</strong></p>
                                                                        <hr>
                                                                    </div>
                                                                    <div class="body">
                                                                        <div class="row clearfix">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $brgy_informant; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-6 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $position_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Contact No:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $contact_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">First Name:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $fnameneighb_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Middle Name:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $mnameneighb_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Last Name:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $lnameneighb_; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Suffix:</label>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $suffixneighb_; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-6 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" style="background-color: #fff;" readonly value="<?php echo $contact_infocharref_neighb; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $address_neighb; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarkscharref_neighb_; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarks_political; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarks_lifestyle; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="body">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            <div class="col-md-12 col-sm-12">
                                                                                <label class="d-block text-muted mb-1">Report Remarks:</label>
                                                                                <div class="form-group">
                                                                                    <textarea rows="4" class="form-control no-resize" style="background-color: #fff; resize: none;" readonly><?php echo $remarks_financial; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
