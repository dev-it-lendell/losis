            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-danger" style="float: right; margin-right: 25px; margin-top: 15px;" onclick="back_adm_monitor_bi(); saveadmmonitorbi();"><i class="fa fa-arrow-left"></i> Back</button>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane" id="opsbiteleendodocs">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4"></div>
                                                <div class="col-md-4">
                                                    <div class="profile-image" style="margin-left: 50px; margin-top: -20px;"> <img src="../images/icons/supporting_docs.png" class="rounded-circle" alt="" style="height: 150px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> </div>
                                                </div>
                                                <div class="col-md-4"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <?php
                                                    $files = scandir("../client_/documents/{$year}/{$acronym_}/{$endo_code}/OtherDocuments/");
