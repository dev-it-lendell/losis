...
<body data-theme="light" class="font-nunito">
    <div id="wrapper" class="theme-green">
        ...
        <div class="right_icon_bar">
            <ul>
                <li onclick="saveadmuserprofile();"><a href="user_profile.php" data-toggle="tooltip" data-placement="top" title="My Profile"><i class="fa fa-user"></i></a></li>
                <li onclick="saveadmusermessaging();"><a href="user_messaging.php" data-toggle="tooltip" data-placement="top" title="My Messaging"><i class="fa fa-comments"></i></a></li>
                <li onclick="saveadmuserticketing(); viewaddticket();"><a href="#" data-toggle="tooltip" data-placement="top" title="My Ticketing"><i class="fa fa-ticket"></i></a></li>
