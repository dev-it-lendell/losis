									...
									<div class="tab-content">
										...
										<div class="tab-pane" id="sup_docs">
											<div class="row">
												...
												<div class="col-lg-6">
												    <p style="font-size: 18px; text-align: center;"><b>E-signature (Letter of Authorization)</b>
												    <p style="font-size: 15px;  text-align: center;"> You can generate your e-signature in this link <a href="https://www.signwell.com/online-signature/draw/" target="_blank">here.</a></p>
													<div class="row">
														<div class="col-md-12">
	                                                        <input type="file" class="dropify" name="e_signature[]" id="e_signature" multiple accept="image/*" />
														</div>
													</div>
												</div>
											</div>
