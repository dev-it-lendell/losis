        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <a onclick="saveviewupdateprofile();" href="update_user_profile.php?userID=<?php echo $clientid ?>" class="btn btn-outline-success" style="float: right;"><i class="fa fa-pencil-square-o"></i>&nbsp;Edit My Profile</a>
                    </div>                
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card profile-header">
                        <div class="body text-center">
                            <?php
                                echo '<div class="profile-image mb-3 text-center"> <img class="img-fluid rounded" src="../profilepictures_/'.$clientid.'/'.$clnt_userimage.'" alt=""> </div>'
                            ?>
                            <div class="mt-4">
                                <h4 class="mb-0"><strong><?php echo $clnt_requestor; ?></strong></h4>
                                <span class="job_post"><?php echo $clnt_position; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-unstyled">
                                <li><p><i class="fa fa-calendar mr-2"></i><strong>Date of Birth:</strong>&nbsp;&nbsp;<?php echo $clnt_newdateofbirth; ?></p></li>
                                <li><p><i class="fa fa-user mr-2"></i><strong>Age:</strong>&nbsp;&nbsp;<?php echo $clnt_userage; ?></p></li>
                                <li><p><i class="fa fa-phone-square mr-2"></i><strong>Contact Number:</strong>&nbsp;&nbsp;<?php echo $clnt_contact; ?></p></li>
                                <li><p><i class="fa fa-map-marker mr-2"></i><strong>Address:</strong>&nbsp;&nbsp;<?php echo $clnt_fulladdress; ?></p></li>
                            </ul>
                            <hr> 
                           ...
                           <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="my_user_logs.php" onclick="saveviewuserlogs();" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="View All" style="margin-left: 15px;"><i class="fa fa-list"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                           ...
                           <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="my_activity_logs.php" onclick="saveviewactivitylogs();" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="View All" style="margin-left: 15px;"><i class="fa fa-list"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="body">
                            <table class="table mb-0">
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM tbl_client_history_logs WHERE MONTH(datetime_log) = MONTH(NOW()) AND YEAR(datetime_log) = YEAR(NOW()) AND user_id = '".$_SESSION["user_id"]."' ORDER BY id DESC LIMIT 5";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                $datetime_log = $row['datetime_log'];
                                                $adm_newdatetimelog = date('F d, Y - g:i A', strtotime($datetime_log));
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $adm_newdatetimelog ?></td>
                                                    </tr>
                                                <?php
                                            }
                                        } else {
