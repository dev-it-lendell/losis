									...
									<div class="col-md-12">
										...
										<div class="row" id="endo_package" style="display: none;">
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><i class="fa fa-cube text-dark"></i></span>
                                                            </div>
                                                            <select class="form-control form-control" name="app_package" id="app_package" onchange="packageValidation();">
