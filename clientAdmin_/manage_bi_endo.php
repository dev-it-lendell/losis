<?php
    ...
    if (!empty($_GET['status'])) {
        switch($_GET['status']){
            ...
            case 'dup_entry':
                $dupDetails = isset($_GET['dupDetails']) ? urldecode($_GET['dupDetails']) : 'No duplicate details found.';
                ?>
                <script type="text/javascript">
                    if (typeof Swal !== 'undefined') {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Duplicate Endorsements Found',
                            html: `<?php echo $dupDetails; ?>`,
                            ...
                            if (result.isConfirmed) {
                                console.log('Proceeding with duplicate endorsement.');
                            } else {
                                console.log('Duplicate endorsement cancelled.');
                            }
                        });
                    } else {
                        ...
                        console.error('Swal is not defined, loading dynamically.');
                    }
                </script>
                <?php
                break;
