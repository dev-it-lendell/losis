                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex flex-row-reverse">
                            <div class="page_action" onclick="savesupdownloaddtritspv();">
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12">
					<div class="card planned_task">
						...
						<form class="form" method="POST" enctype="multipart/form-data" action="functions/save_spv_dtr.php">
							<div class="header">
								<div class="row">
									<div class="col-md-12">
										<div class="row">
							...
							<div class="body" style="margin-top: -30px;">
								...
								<br>
	                            <button type="submit" class="btn btn-outline-success" name="importDTRSPV"><i class="fa fa-check-circle-o"></i> Submit</button>
