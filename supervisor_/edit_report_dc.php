				...
				<div class="row">
					<div class="col-lg-8 col-md-6 col-sm-12">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item">Review Endorsement</li>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12">
					<div class="card planned_task">
						<div class="row">
							<div class="col-md-12">
								<button type="button" class="btn btn-danger" style="float: right; margin-right: 25px; margin-top: 15px;" onclick="backtoreviewendodc(); savepocreviewdc();"><i class="fa fa-arrow-left"></i> Back</button>
							</div>
						</div>
						<div class="header">
						...
						<form class="form" method="POST" enctype="multipart/form-data" action="functions/update_dc_report.php">
							<div class="body">
								<div id="wrapper" class="theme-green">
									<div class="row clearfix">
												...
												<div class="body">
													<div class="row text-center mt-2 border-bottom pb-2">
														<div class="col-md-12">
															...
															<p id="biendorsement_name" style="font-size: 13px;"><?php echo $applicantname; ?></php6>
														</div>
													</div>
													<div class="row text-center mt-2 border-bottom pb-2">
												...
												<div class="body">
													<div class="row">
														<div class="col-md-12">
															...
															<input type="hidden" class="form-control"  id="clientid" name="clientid" readonly style="background-color: #fff; text-align: left; color: #000; font-size: 13px;" value="<?php echo $clientuserid; ?>">
															<div class="row">
																<div class="col-md-6">
																	<small class="text-muted">Endorsement Description: </small>
									...
									<div class="row clearfix">
												...
												<div class="body">
													<div class="row">
														<div class="col-md-12">
															...
															<select class="form-control input-group-sm" id="verificationstatus" name="verificationstatus" style="float: left;">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<select class="form-control input-group-sm" id="verificationcode" name="verificationcode" style="float: left;" onchange="enabledisabledc()">
					                                ...
					                                <div class="row">
					                                	<div class="col-md-12">
															<small class="text-muted">Verification Remarks: </small>
																<textarea class="form-control" rows="3" id="verificationremarks" name="verificationremarks" style="resize: none;" placeholder="Type Remarks Here"></textarea>
					                                	</div>
					                                </div>
					                                <hr>	
												</div>
						           	...
						           	<button type="submit" class="btn btn-outline-success" name="updateReport"><i class="fa fa-check-circle-o"></i> Submit</button>
