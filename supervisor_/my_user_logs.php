                                    ...
                                    <div class="card-body">
                                        <div class="media mleft">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p id="officialpocmonthlyuserlogs" style="font-size: 25px; text-align: right; margin-top: -55px; font-weight: bold;"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media mleft">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p id="officialpocyearlyuserlogs" style="font-size: 25px; text-align: right; margin-top: -55px; font-weight: bold;"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
