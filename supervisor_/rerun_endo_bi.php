<?php
    ...
    if (!empty($_GET['approvalbi'])) {
        switch ($_GET['approvalbi']) {
            case 'succ':
                ?>
                    ...
                    <div class="card planned_task">
                        <div class="body">
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#bipendingpackage">Pending</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#biapprovedpackage">Approved</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#bideniedpackage">Denied</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane show active" id="bipendingpackage">
                                    <div class="header">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center;">
                                                                        <a onclick="savepocrerunbiapprovalpkg()" href="rerun_approval_bi.php?endoCode=<?php echo $row['endo_code'] ?>" class="btn btn-sm btn-outline-success" data-toggle="tooltip" data-placement="top" title="Approval of Package"><i class="fa fa-check-circle-o"></i></a>
                                                                        <button type="button" class="btn btn-sm btn-outline-dark" data-toggle="tooltip" data-placement="top" title="View Rerun Endorsement" onclick="savepocrerunbiviewrerunendo();"><i class="fa fa-file-text-o"></i></button>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                ...
                                <div class="tab-pane" id="biapprovedpackage">
                                    <div class="header">
                                        <div class="card" style="height: 85px; margin-left: -20px;">
                                            <div class="card-body">
                                                <div class="media mleft">
                                ...
                                <div class="tab-pane" id="bideniedpackage">
                                    <div class="header">
                                        <div class="card" style="height: 85px; margin-left: -20px;">
                                            <div class="card-body">
                                                <div class="media mleft">
