			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12">
					<div class="card planned_task">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-outline-danger" style="float: right; margin-right: 25px; margin-top: 15px;" onclick="back_spv_monitor_dc(); savemonitorendodc();"><i class="fa fa-arrow-left"></i> Back</button>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4"></div>
                                                <div class="col-md-4">
                                                    <div class="profile-image" style="margin-left: 50px; margin-top: -20px;"> <img src="../images/icons/assign.png" class="rounded-circle" alt="" style="height: 150px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> </div>
                                                </div>
                                                <div class="col-md-4"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <?php
                                                        $sql = "SELECT a.endo_code, a.assigned_supervisor, b.user_id, CONCAT(b.user_id) AS asspocid, CONCAT(b.fname, ' ', b.mname, ' ', b.lname, ' ', b.suffix) AS asspocname, CONCAT(b.user_image) AS asspocimg FROM tbl_endorsement_dc_process AS a LEFT JOIN tbl_supervisor AS b ON a.assigned_supervisor = b.user_id WHERE a.endo_code = '".$_GET["endoCode"]."'";
                                                ...
                                                <div class="col-md-4">
                                                    <?php
                                                        $sql = "SELECT a.endo_code, a.assigned_support, b.user_id, CONCAT(b.user_id) AS asssupid, CONCAT(b.fname, ' ', b.mname, ' ', b.lname, ' ', b.suffix) AS asssupname, CONCAT(b.user_image) AS asssupimg FROM tbl_endorsement_dc_process AS a LEFT JOIN tbl_support AS b ON a.assigned_support = b.user_id WHERE a.endo_code = '".$_GET["endoCode"]."'";
                                                        $result = mysqli_query($conn, $sql);
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <div class="col-md-4">
                                                    <?php
                                                        $sql = "SELECT a.endo_code, a.assigned_analyst, b.user_id, CONCAT(b.user_id) AS assteleid, CONCAT(b.fname, ' ', b.mname, ' ', b.lname, ' ', b.suffix) AS asstelename, CONCAT(b.user_image) AS assteleimg FROM tbl_endorsement_dc_process AS a LEFT JOIN tbl_operations AS b ON a.assigned_analyst = b.user_id WHERE a.endo_code = '".$_GET["endoCode"]."'";
                                                        $result = mysqli_query($conn, $sql);
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php
                                                        $sql = "SELECT a.endo_code, a.review_supervisor, b.user_id, CONCAT(b.user_id) AS revpocid, CONCAT(b.fname, ' ', b.mname, ' ', b.lname, ' ', b.suffix) AS revpocname, CONCAT(b.user_image) AS revpocimg FROM tbl_endorsement_dc_process AS a LEFT JOIN tbl_supervisor AS b ON a.review_supervisor = b.user_id WHERE a.endo_code = '".$_GET["endoCode"]."'";
                                                        $result = mysqli_query($conn, $sql);
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <div class="col-md-6">
                                                    <?php
                                                        $sql = "SELECT a.endo_code, a.assigned_client, b.user_id, CONCAT(b.user_id) AS assclientid, CONCAT(b.fname, ' ', b.mname, ' ', b.lname, ' ', b.suffix) AS assclientname, CONCAT(b.user_image) AS assclientimg FROM tbl_endorsement_dc_process AS a LEFT JOIN tbl_client AS b ON a.assigned_client = b.user_id WHERE a.endo_code = '".$_GET["endoCode"]."'";
                                                        $result = mysqli_query($conn, $sql);
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4"></div>
                                                <div class="col-md-4">
                                                    <div class="profile-image" style="margin-left: 50px; margin-top: -20px;"> <img src="../images/icons/history.png" class="rounded-circle" alt="" style="height: 150px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> </div>
                                                </div>
                                                <div class="col-md-4"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table table-hover js-basic-example dataTable table-custom table-striped m-b-0 c_list">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT a.endo_code, b.id, b.endo_code, b.endo_action, b.assigned_team, b.datetime_added, c.team_no, c.team_name FROM tbl_endo_criminal AS a LEFT JOIN endorsement_logs AS b ON a.endo_code = b.endo_code LEFT JOIN team_list AS c ON b.assigned_team = c.team_no WHERE b.endo_code = '".$_GET["endoCode"]."' ORDER BY b.id DESC";
