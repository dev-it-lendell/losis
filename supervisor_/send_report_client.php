											...
											<div class="card member-card">
												...
												<div class="body">
													...
													<div class="row text-center mt-2 border-bottom pb-2">
														...
														<input type="hidden" class="form-control" name="endocode" readonly value="<?php echo $endoCode; ?>">
														<input type="hidden" class="form-control" name="endoid" readonly value="<?php echo $endo_id; ?>">
														<input type="hidden" class="form-control" name="clientid" readonly value="<?php echo $clientid; ?>">
														<input type="hidden" class="form-control" name="clientemail" readonly value="<?php echo $clientemail; ?>">
														<input type="hidden" class="form-control" name="applicantname" readonly value="<?php echo $applicantname; ?>">
