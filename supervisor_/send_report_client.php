        ...
        <div class="row clearfix">
          <div class="col-lg-12 col-md-12">
            <div class="card planned_task">
              <div class="row">
                <div class="col-md-12">
                  <button type="button" class="btn btn-outline-danger"
                    ...
                    onclick="back_endorsements_bi(); saveendorsementbi();"><i class="fa fa-arrow-left"></i>
                    Back</button>
                </div>
              </div>
              <div class="header">
              ...
              <form class="form" method="POST" id="reportSending" action="functions/save_client_report.php"
                ...
                <div class="body">
                  <div id="wrapper" class="theme-green">
                          ...
                          <div class="body">
                            <div class="row">
                              <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-6">
                                    <small class="text-muted">Endorsement
                                      Description:
                                    </small>
                                    <p id="biendorsement_desc">
                                      <?php echo $endo_desc; ?>
                                    </p>
                                    <hr>
                                  </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-6">
                                    <small class="text-muted">Turn Around Date:
                                    </small>
                    ...
                    <div class="row clearfix">
                      <div class="col-lg-12 col-md-12 col-sm-12" v-if="!this.bools.innerLoading">
                        <div class="card">
                          <div class="header">
                      ...
                      <q-inner-loading :showing="this.bools.innerLoading">
                        <span class="q-pt-md q-py-md text-overline text-center">LOADING, PLEASE WAIT
                          ...</span>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      form.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          this.bools.innerLoading = true
          formData.append('document_tag_name', Number(value) === 1 ? 'final_bi_report' :
            'interim_bi_report')
          formData.append('sendreporttoclient', '1');

          const response = await fetch(
            `<?php echo $apiURL; ?>losis/candidates/send-report/${invitationId}`, {
              method: 'POST',
              body: formData,
            });
          ...
          await fetch(`<?php echo getBaseUrl() . "functions/save_client_report.php"; ?>`, {
              method: 'POST',
              body: formData,
              redirect: 'manual',
            })
            ...
            .then(data => {
              window.location.href = `<?php echo getBaseUrl(); ?>endorsement_bi.php${data.redirect}`
            })
            .catch(error => {
              console.error('Error:', error);
            });

          this.bools.innerLoading = false
