			...
			document.addEventListener('DOMContentLoaded', () => {
				...
				form.addEventListener('submit', async (e) => {
					...
					try {
						...
						formData.append('document_tag_name', Number(value) === 1 ? 'final_bi_report' : 'interim_bi_report')
						...
						// const response = await fetch(`<?php echo $getBaseUrl; ?>/functions/save_client_report.php`, {
						// 	method: 'POST',
						// 	body: formData,
						// });
