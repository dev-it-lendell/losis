                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex flex-row-reverse">
                            <div class="page_action" onclick="savepocdownloaddtr();">
                                <a class="btn btn-success" href="download_dtr.php?file=dtr_template/supervisor_dtr_template_2023.csv" style="float: right;"><i class="fa fa-download"></i> Download DTR</a>
                            </div>
                        </div>
                    </div>                
                </div>
										...
										<div class="row">
											<div class="col-md-6">
												<small class="text-muted">Full Name: </small>
													<p style="font-weight: bold;"><?php echo $spv_name; ?></p>
												<hr>
											</div>
											<div class="col-md-6">
												<small class="text-muted">Designation: </small>
													<p style="font-weight: bold;"><?php echo $spv_position; ?></p>
												<hr>
											</div>
										</div>
									</div>
